...
Using actor-critic algorithm leads to faster convergence. Though, for the same reason as in the previous chapter, we disable gravity to make the task easier.
